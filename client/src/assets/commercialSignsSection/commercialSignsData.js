...
export const commercialSignsData = {
  categories: [
    ...
    {
      id: 3,
      title: "Decorative Sign Printing",
      items: [
        {
          id: 301,
        ...
        },
        {
          id: 303,
          title: "PVC Signs",
          description: "Create personalized signs to turn heads with cool styles and high-resolution graphics great for branding as well as personal use.",
          tags: ["Best Seller"],
          img: pvcSignsImg,
        },
        {
