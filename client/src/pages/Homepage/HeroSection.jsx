...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cyan-50 to-red-50 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto pt-20 lg:pt-12 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Column */}
          <div className="space-y-8">
            <div className="inline-flex items-center bg-cyan-100 text-cyan-700 rounded-full px-4 py-1.5 gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                className="bg-red-600 hover:bg-red-700 transition-colors text-white px-6 py-3 rounded-lg font-medium inline-flex items-center justify-center gap-2"
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              ...
              <div className="text-center">
                <h3 className="text-3xl font-bold text-cyan-600">24h</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex rounded-lg overflow-hidden border border-slate-200">
                    <button 
                      className={`flex-1 py-2 px-4 text-sm font-medium ${sizeUnit === 'inch' ? 'bg-cyan-600 text-white' : 'bg-white text-slate-600'}`}
                      onClick={() => setSizeUnit('inch')}
                    >
                      Inch
                    </button>
                    <button 
                      className={`flex-1 py-2 px-4 text-sm font-medium ${sizeUnit === 'feet' ? 'bg-cyan-600 text-white' : 'bg-white text-slate-600'}`}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {standardSizes.map((size) => (
                      <button
                        key={size.id}
                        className={`p-3 rounded-lg border ${selectedStandardSize === size.id && !isCustomSize ? 'border-cyan-600 bg-cyan-50' : 'border-slate-200 hover:border-slate-300'}`}
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-cyan-600 rounded border-slate-300 focus:ring-cyan-500"
                  />
                ...
                <button 
                  className="w-full bg-red-500 hover:bg-red-600 transition-colors text-white py-3 px-6 rounded-lg font-medium"
