...
const DesignPopup = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-4 backdrop-blur-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            ...
            >
              ...
              <div className="relative z-10 transform translate-z-20">
                ...
                <h3 className="text-xl font-semibold text-slate-800 mt-4 mb-3 group-hover:text-cyan-700">Use a template</h3>
                <p className="text-slate-600 mb-4">Save time with our professionally designed templates.</p>
                <div className="text-cyan-600 hover:text-cyan-800 font-medium flex items-center gap-2">
                  Browse Templates
            ...
            >
              ...
              <div className="relative z-10 transform translate-z-20">
                ...
                <h3 className="text-xl font-semibold text-slate-800 mt-4 mb-3 group-hover:text-cyan-700">Design your own</h3>
            ...
            >
              ...
              <div className="relative z-10 transform translate-z-20">
                ...
                <h3 className="text-xl font-semibold text-slate-800 mt-4 mb-3 group-hover:text-cyan-700">Upload your design</h3>
